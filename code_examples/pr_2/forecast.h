...
/* Exercise 3 */
void getExtremeTempForecast(const tSkiResort *resort, float *minTemp, float *maxTemp);
/* Exercise 4 */
void getResortsWithSnowPrediction(const tSkiResortsTable *allResorts, tTemperature scale, tSkiResortsTable *snowyResorts);
